...
class CodeWriter:
    ...
    def write_if(self, label):
        ...
        self.write_pop_D()
        # self.write(self.current_function)
        # self.write(label)
        self.write('@' + self.current_function_name() + '$' + label)
        self.write('D;JNE')

    def write_function(self, function_name, num_locals):
        # self.write_comment(f'function {function_name} {num_locals}')
    ...
    def write_call(self, function_name, num_args):
        # self.write_comment(f'call {function_name} {num_args}')
        # push return-address
        return_label = f'{function_name}${self.label_index}'
        self.label_index += 1
        # self.write(f'// push return-address')
        ...
        # goto function_name
        # self.write(f'// goto {function_name}')
        self.write(f'@{function_name}')
        self.write(f'0;JMP')

        # (return-address)
        # self.write(f'// (return-address)')
        self.write(f'({return_label})')
